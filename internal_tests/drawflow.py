...
if __name__ == "__main__":
    drawflow_instance = DrawFlow.from_yaml(
        "test_flow_yaml_draw.yaml",
        tools=[WikipediaTool(), DuckDuckGoSearchTool(), WebsiteTool()]
    )
    drawflow_instance.save_to_json("test.json")
    drawflow_instance.generate_html("index.html", "output3.html")
